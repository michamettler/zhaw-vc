...
Work through a typical stereo matching pipeline and document 
  - Steps,
  - Results, and 
  - Insights
...
Task: record your own images AND/OR download stere image pairs from http://vision.middlebury.edu/stereo/data/. Perform stereo image matching and get disparity maps and 2.5d point clouds.

**Play around with it!** Try to understand what's going on and ask yourself questions, such as: When does it work, what are limitations? How might these limitations be overcome? How well is it working on your own images -- why/ why not?
